interface CardAnimeLoaderProps {
  additionalStyle?: string;
}

const CardAnimeLoader = ({ additionalStyle }: CardAnimeLoaderProps) => {
  return (
    <div
      className={`${additionalStyle} group relative h-50 animate-pulse cursor-pointer overflow-hidden rounded-md bg-slate-500 shadow-sm`}
    >
